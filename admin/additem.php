...
<h3 class="inner-tittle two" style="font-weight:bold">Chronicle</h3>
<div class="form-body">
...
<option value="Meat&Seafoods">Meat & Sea Foods</option>
...
<div class="col-xs-6"> 
<center><input type="submit" class="btn btn-success" name="elect_submit" id="elec_submit" value="Submit"></center> </div> </form> 
</div>
