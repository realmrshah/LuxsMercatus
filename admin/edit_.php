...
<h2 class="inner-tittle">Update Product</h2>
...
<div class="form-body">
<form class="form-horizontal" action="view_item_list.php" method="post" enctype="multipart/form-data"> 
<?php
...
<label for="inputPassword3" id="errortitle" class="col-sm-2 control-label">ID</label> 
<div class="col-xs-6"> 
<input type="hidden" value="<?=$elecid?>" class="form-control"  name='uid' placeholder="Title"> 
<input type="text" value="<?=$elecid?>" class="form-control"  name='uid' placeholder="Title"> 
</div>
</div>
<div class="form-group">
...
<div class="form-group">
<label for="inputPassword3" id="errormetakey" class="col-sm-2 control-label">Category</label> 
<div class="col-xs-6"> 
<input type="text" value="<?=$category?>" class="form-control" name='ucategory' placeholder="Keyword"> 
</div>
</div>
<div class="form-group">
<label for="inputPassword3" id="errormetakey" class="col-sm-2 control-label">Rating</label> 
<div class="col-xs-6"> 
<input type="text" value="<?=$elec_rating?>" class="form-control" name='urating' placeholder="Rating"> 
</div>
</div>
<div class="form-group"> 
<label for="inputEmail3" id="image" class="col-sm-2 control-label">Cover Image</label> 
<div class="col-xs-6">
<input type="file" value="<?=$image?>" class="form-control col-xs-4"  name="uimage" > 
</div> 
</div>
...
<div class="form-group"> 
<label for="inputEmail3" id="cpassworderror" class="col-sm-2 control-label">Project Description</label> 
<div class="col-xs-6">
...
<div class="col-sm-6"> 
<center><input type="submit" class="btn btn-success" id="project_submit" value="Update"><a href="view_item_list.php"></center> </div> </form> 
</div>
<?php
}
?>
