            ...
            <div class="row h-100">
                <div class="col-12 h-100">
                    <nav class="h-100 navbar navbar-expand-lg">
					 <a class="navbar-brand" href="index.php">LUX Marcatus</a>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Contact us +91 7204873414 | Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href=https://instagram.com/_.hedonist._/" target="_blank">LUCIFIEUR</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </p>
                    </div>
