...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
     <title>LUX Mercatus &amp; Home</title>

          
    <link rel="icon" href="img/core-img/favicon.ico"><a href="index.php">
...
<body>
   ...
   <header class="header_area" id="header">
     ...
     <section class="dorne-welcome-area bg-img bg-overlay" style="background-image: url(img/bg-img/banner.jpg);">
        <div class="container h-100">
            <div class="row h-100 align-items-center justify-content-center">
                <div class="col-12 col-md-5"></br></br>
                    <div class="hero-content"></br></br></br></br></br>
                         <h3 style="color:red;font-weight:bold;  text-shadow: 2px 2px 14px #80FF00;">Namma Bengaluru</h3>
                              <h3 style="color:white;font-weight:bold;  text-shadow: 2px 2px 14px #80FF00;">SEARCH YOUR PRODUCT</h3>
...
<div class="col-lg-4">
  <button type="submit" name="onsearch" id="search_click" class="btn btn-success ">Search or View all</button></div>
</form> 
...
<div id="countryList" style="background-color:yellow"></div>  
    ...
    <section class="dorne-features-destinations-area">
        <div class="container-fluid">
           ...
           <?php
           $result=select("select * from items where category='Fruit, Vegetables'");
      ...
      <div class="row">
           ...
           <?php
           $result=select("select * from items where category='Food grains, oil, Masala'");
           while($r=mysqli_fetch_array($result))
           {
             extract($r);
           ?>
      ...
      <div class="row">
           ...
           <?php
           $result=select("select * from items where category='Cleaning household'");
           while($r=mysqli_fetch_array($result))
           {
             extract($r);
           ?>
 ...
 &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made  <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://instagram.com/_.hedonist._" target="_blank">Lucifiuer</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </p>
                    </div>
