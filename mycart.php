...
<head>
    ...
    <!-- Title -->
    <title>LUX  &amp; Mercatus | MY CART</title>

    <!-- Favicon -->
    <link rel="icon" href="htdocs\LUX\img\core-img">
...
<body>
  ...
  <p style="color:green;font-weight:bold;font-size:20px;">My Cart Details<p>
</div>
        </div>
		 <div class="col-lg-1 text-center"></div>
...
Remove
  ...
  <td><a href="myphp.php?dele=yes&id=<?=$cartid?>">
          <span class="btn btn-success">X</span>
        </a></td>
  <?php
	 $n++;
	 }
  ...
  {extract($t);
  ?>
     <a href="#" class="btn btn-success" style="font-weight:bold">Total Price - Rs.<?=$t[0]?>/-</a>
	 <a href="cod.php?price=<?=$t[0]?>"><span class="btn btn-success">COD</span></a>
            ...
            <div class="row">
                <div class="col-12 d-md-flex align-items-center justify-content-between">
                    <div class="footer-text">
                        <p>
                            <footer class="dorne-footer-area">
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Contact us @ +91 7204873414 | This template is made  <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://instagram.com/_.hedonist._" target="_blank">Lucifiuer+</a>
                        </p>
                    </div>
